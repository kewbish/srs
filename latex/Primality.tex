...
\section{Agarwal-Kayal-Saxena Primality Test} % https://www.cse.iitk.ac.in/users/manindra/algebra/primality_v6.pdf
...
Each primality test was analyzed in a standard way over three trials; the raw data is available in Appendix A. Each trial tested a different $k$ value, and consisted of: % TODO: Note differences in testing method with AKS due to no base available
\begin{itemize}
